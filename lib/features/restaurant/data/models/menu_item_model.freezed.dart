...
mixin _$MenuItemModel {
  ...
  List<MenuItemOptionModel>? get options => throw _privateConstructorUsedError;
...
class _$MenuItemModelImpl implements _MenuItemModel {
  ...
  final List<MenuItemOptionModel>? _options;
  @override
  List<MenuItemOptionModel>? get options {
  ...
  @override
  String toString() {
    return 'MenuItemModel(id: $id, sectionId: $sectionId, restaurantId: $restaurantId, name: $name, description: $description, imageUrl: $imageUrl, options: $options, price: $price, available: $available)';
  }
...
abstract class _MenuItemModel implements MenuItemModel {
  const factory _MenuItemModel(
      ...
      required final bool available}) = _$MenuItemModelImpl;
